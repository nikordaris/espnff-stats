export function parsePlayerStats({ responseData, constructorParams, usesPoints, seasonId, statKey, statSourceId, statSplitTypeId }: {
    responseData: any;
...
declare class PlayerStats extends BaseObject {
     ...
     */
    static responseMap: PlayerStats;
    constructor(options?: {});
    usesPoints: any;
}
